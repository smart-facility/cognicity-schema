...
$BODY$
	BEGIN
        ...
        SELECT NEW.pkey, NEW.created_at, NEW.text, 'grasp', NEW.disaster_type, card.language, 'data.petabencana.id/'||card.card_id, NEW.card_data, NEW.the_geom, NEW.image_url
